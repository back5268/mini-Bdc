...
export const getListProjectInfoApi = (params) => getData('/info/getListProjectInfo', params);
export const getListApartmentInfoApi = (params) => getData('/info/getListApartmentInfo', params);
export const getListResidentInfoApi = (params) => getData('/info/getListResidentInfo', params);
